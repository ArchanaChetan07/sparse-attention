...
- `dense_qa_accuracy` (0.4375 here — inflated by substring false positives)
- `h4_all_requests`, `h4_answerable`, `h4_answerable_within_budget`
  (reported ρ = −0.898 answerable; **H4 is a pre-committed gate criterion**)
- `h4_floor_effect`
...
- `auc_teacher_flip`, `auc_within_budget`, `signal_vs_damage` (best label-free
  AUC 0.850, above the 0.65 falsification threshold → H1 supported)
