...
![ROC curves 0.5B v2](results/study_a_0.5b_v2/figures/roc.png)
...
| 0.5B ROC | 0.5B cliff |
|---|---|
| ![ROC 0.5B v2](results/study_a_0.5b_v2/figures/roc.png) | ![Cliff 0.5B v2](results/study_a_0.5b_v2/figures/cliff.png) |
...
|---|---|---|
| **A** (H1/H4) | `python experiments/study_a_smoke.py --model Qwen/Qwen2.5-1.5B-Instruct --out results/study_a_1.5b_v2` | `steps.csv`, `requests.csv`, figures, `summary.json` |
| **A analysis** | `python experiments/analyze_study_a.py results/study_a_0.5b_v2 results/study_a_1.5b_v2` | Rewrites `summary.json` + figures |
